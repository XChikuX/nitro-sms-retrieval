...
namespace margelo::nitro::huymobile::smsretriever {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/com/smsretriever/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/com/smsretriever/Func_void_cxx;";
